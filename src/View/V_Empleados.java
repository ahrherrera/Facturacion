 ...
 * @author ahrhe
 */
public class V_Empleados extends javax.swing.JInternalFrame implements Interface {

    /**
     * Creates new form V_Empleados
     */
    Validate v = new Validate();
    ModelTableEmpleado model = new ModelTableEmpleado(C_Empleado.findAll());
    ...
    private void initComponents() {
        ...
        cb_cargo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "( Elija un Cargo )", "Vendedor", "Bodeguero" }));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Usuario", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Monotype Corsiva", 0, 18))); // NOI18N

        jLabel12.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("Correo electrónico :");

        btn_reestablecer.setText("Reestablecer contraseña");

        jLabel13.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel13.setText("Nombre de usuario :");

        btn_desactivar.setText("Desactivar Acceso");
        ...
        cb_rol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Agente de Ventas", "Bodega" }));
        cb_rol.setEnabled(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btn_reestablecer, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        panelCentralLayout.setVerticalGroup(
            ...
            .addGroup(panelCentralLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panelTabla, javax.swing.GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelCentral, javax.swing.GroupLayout.DEFAULT_SIZE, 851, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelCentral, javax.swing.GroupLayout.DEFAULT_SIZE, 630, Short.MAX_VALUE)
        );
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
            ...
            if (v.validateEmail(txt_email.getText()) && !txt_user.getText().isEmpty()) {
                Empleado emp = C_Empleado.findObject(idEmpleado);
                JOptionPane.showMessageDialog(null,C_Usuario.Insertar(emp, txt_user.getText(), cb_rol.getSelectedItem().toString(), txt_email.getText()));
            }else if (!v.validateEmail(txt_email.getText())) {
                v.ShowMessage("Formato de Email no valido!", v.error_Message);
            }
        
    }//GEN-LAST:event_btn_registrarActionPerformed

    private void cb_cargoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cb_cargoItemStateChanged
        if (cb_cargo.getSelectedIndex()==1) {//Vendedor
            cb_rol.setSelectedIndex(0);
        }else if (cb_cargo.getSelectedIndex()==2) { //Bodeguero
    ...
    private void btn_desactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_desactivarActionPerformed
        if (idEmpleado>0) {
            ...
            try{
            C_Empleado.cambiarEstado(idEmpleado);
            v.ShowMessage("Operacion Exitosa!", v.info_Message);
            }catch(Exception ex){
                ex.printStackTrace();
              v.ShowMessage("Error al desactivar acceso", v.error_Message);
            }
        }
    ...
    public void EnableFields(boolean option) {
        ...
        txt_user.setEditable(option);
        cb_rol.setEnabled(option);
        this.txt_email.setEditable(option);
        btn_reestablecer.setEnabled(option);
        btn_registrar.setEnabled(option);
        btn_desactivar.setEnabled(option);
    ...
    public void LoadFields() {
        ...
        user = C_Empleado.retorna(idEmpleado);
        txt_user.setText(user.getNombreUsuario());
        txt_email.setText(user.getCorreo());
