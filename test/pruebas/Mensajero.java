...
public class Mensajero {
    ...
    public static void main(String[] args) {
        ...
        destinatarios.add("allanhavidramirez@gmail.com");
        men.enviarMensaje("Mensaje de Prueba",destinatarios );
    }
    ...
    public void enviarMensaje(String mensaje, List<String> destinatarios){
